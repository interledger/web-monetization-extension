...
import { PaymentStreamManager } from './paymentStream';
...
export class MonetizationService {
  private createLogger: Cradle['createLogger'];
  ...
  async startPaymentSession(
    ...
    if (!paymentManager) {
      paymentManager = new PaymentStreamManager(
        tabId,
        ...
        rateOfPay,
        {
          ...
          logger: this.createLogger('payment-manager'),
