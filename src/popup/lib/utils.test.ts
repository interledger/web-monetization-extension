...
describe('formatNumber', () => {
  ...
  it('should display right format for real numbers smaller than 1', () => {
    ...
    expect(res).toEqual('0.000000009')

    res = formatNumber(0.00009, 9)
    expect(res).toEqual('0.00009')

    res = formatNumber(0.000000009, 9, true)
    expect(res).toEqual('9e-9')

    res = formatNumber(0.00009, 9, true)
    expect(res).toEqual('9e-5')

    res = formatNumber(0.0000109, 9, true)
    expect(res).toEqual('1.09e-5')

    res = formatNumber(0.000010009, 9, true)
