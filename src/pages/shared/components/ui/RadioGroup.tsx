  ...
  return (
    ...
    >
      ...
      <label htmlFor={inputId} className="group flex items-center">
        <span className="inline-block h-6 w-6 rounded-full border-2 border-base in-[.group]:peer-checked:border-blue-500 in-[.group]:peer-checked:bg-primary in-[.group]:peer-checked:ring-4 in-[.group]:peer-checked:ring-inset in-[.group]:peer-checked:ring-white" />
        {label ? (
